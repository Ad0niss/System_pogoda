    ...
    class Program
    {
        static void Main(string[] args)
        {
            try
            {
                ...
                Opad_deszczu od1 = new Opad_deszczu("15/11/2019 15:07", "15/11/2019 15:55", Skala_zagr.neutralne, 15, 4, Typ.fronatlny, 59, 1130, 55);
                s1.Dodaj(od1);
                Burza b1 = new Burza("15/11/2019 15:07", "15/11/2019 15:55", Skala_zagr.neutralne, 15, 315, 4, Typ.fronatlny, -24, 1005, 55);
                Tornado t1 = new Tornado("15/11/2019 15:07", "15/11/2019 15:55", Skala_zagr.bardzo_niebezpieczne, 32m, 1000, 55, SkalaFujity.F4);
                s1.Dodaj(b1);
                s1.Dodaj(t1);
                Console.WriteLine(c_Slask);
                c_Slask.ZapiszXML("kupa.xml");
            }
